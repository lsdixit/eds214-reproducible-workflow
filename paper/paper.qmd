...
Packages used were loaded from the [01_environment-installation.R]()All four data frames were read in, cleaned, and the moving average function applied to each individually in the [01_data-cleaning.R](https://github.com/lsdixit/eds214-reproducible-workflow/blob/main/01_data-cleaning.R) file. 
